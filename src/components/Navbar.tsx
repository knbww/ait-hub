        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-6 py-2 border-2 border-gray-900 rounded-full font-normal hover:bg-gray-900 hover:text-white hover:scale-105 hover:shadow-[0_4px_16px_0_rgba(0,0,0,0.25)] transition-all duration-300"
            >
              Apply Now
            </button>
            <button className="hover:scale-110 hover:rotate-12 transition-all duration-300">
